...
## 🏗️ How the application is organized
...
### **Database Connection**
The server connects to an Oracle database using:
- Username: SVANEGAS
- Password: SVANEGAS
- Server: 190.60.231.121:8080/isispdb.utadeo.edu.co
...
1. **User Authentication** - Login system for clients and admins
2. **Email Notifications** - Automatic updates when letters are ready
3. **File Attachments** - Allow clients to upload documents
4. **Payment System** - Online payment for letter services
5. **Mobile App** - Native mobile application
6. **Advanced Search** - Better ways to find specific information

## 📞 Support and Contact

### **For Developers**
- Check the code comments for technical details
- Review the database structure in the SQL files
...
This Auto Memory Doll application is a **complete web-based system** for managing a letter-writing service. It provides:
...
The application is designed to be **simple to use** for regular users while providing **powerful tools** for administrators to manage the entire system effectively.

---

*This documentation is written in simple language to help anyone understand how the application works, whether they're technical users, business stakeholders, or just curious about the system.*
